...
const config = {
  info: {
    ...
    grupwa: "https://chat.whatsapp.com/HXvvUEsByKd6UaWPHL79B9",
  },

  owner: {
    name: "kyoo", // Nama owner
    number: ["6288226741857"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "6287871743919", // Nomor WA yang akan di-pair
  ...
  vercel: {
    ...
    token: "vcp_7B6iF0WWEWIWfGCnnO9BzpJa4rbfUBiXV23POYR2cstaIrzRez0IW3AJ", // Vercel Token untuk fitur deploy ( Kalau .deploy mau work, ini wajib di isi )
  },
  ...
  saluran: {
    ...
    link: "https://whatsapp.com/channel/0029VbBAp4T1SWt1M9Q3b10V", // Link saluran
  },
  ...
  geminiApiKey: "AQ.Ab8RN6Ir_Ao9y4N8aL98ZsL0fkCcCnbf8C0mKr9mEqKYAfsj4Q",
...
- Jangan mengaku sebagai AI atau bot.`,
  ...
  // Aset gambar/video/audio/font yang dipakai plugin (menu, sticker, dll)
  assets: {
